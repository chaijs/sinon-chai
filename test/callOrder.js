...
describe("Call order", function() {
  ...
  describe("spy1 calledBefore spy2", function() {
    it("should throw an assertion error when neither spy is called", function () {
      expect(function () { spy1.should.have.been.calledBefore(spy2); }).to.throw(AssertionError);
    });

    it("should not throw when only spy 1 is called", function() {
      spy1();

      expect(function () { spy1.should.have.been.calledBefore(spy2); }).to.not.throw();
    });
  ...
  describe("spy1 calledImmediatelyBefore spy2", function() {
    it("should throw an assertion error when neither spy is called", function () {
      expect(function () { spy1.should.have.been.calledImmediatelyBefore(spy2); }).to.throw(AssertionError);
    });
    ...
    it("should not throw when spy 1 is called immediately before spy 2", function() {
      ...
      expect(function () { spy1.should.have.been.calledImmediatelyBefore(spy2); }).to.not.throw();
    });
  ...
  describe("spy1 calledAfter spy2", function() {
    it("should throw an assertion error when neither spy is called", function () {
      expect(function () { spy1.should.have.been.calledAfter(spy2); }).to.throw(AssertionError);
    });
    ...
    it("should not throw when spy 1 is called after spy 2", function() {
      ...
      expect(function () { spy1.should.have.been.calledAfter(spy2); }).to.not.throw();
    });
  });

  describe("spy1 calledImmediatelyAfter spy2", function() {
    it("should throw an assertion error when neither spy is called", function () {
      expect(function () { spy1.should.have.been.calledImmediatelyAfter(spy2); }).to.throw(AssertionError);
    });
    ...
    it("should not throw when spy 1 is called immediately after spy 2", function() {
      ...
      expect(function () { spy1.should.have.been.calledImmediatelyAfter(spy2); }).to.not.throw();
    });

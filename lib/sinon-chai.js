(function (sinonChai) {
    ...
    function sinonProperty(name, action, nonNegatedSuffix) {
        utils.addProperty(chai.Assertion, name, function () {
    ...
    function exceptionalSinonMethod(chaiName, sinonName, action, nonNegatedSuffix) {
        utils.addMethod(chai.Assertion, chaiName, function () {
            assertIsAboutSpy(this);

            var alwaysSinonMethod = "always" + sinonName[0].toUpperCase() + sinonName.substring(1);
            var shouldBeAlways = utils.flag(this, "always") && typeof this.obj[alwaysSinonMethod] === "function";
    ...
    utils.addProperty(chai.Assertion, "always", function () {

...
module.exports = function (chai) {
    ...
    function sinonMethod(name, action) {
        method(name, function (other) {
            ...
            this.assert(this.obj[sinonMethod].call(this.obj, other),
                        "expected " + this.obj.displayName + " to " + verbPhrase + action + " " + otherString,
                        "expected " + this.obj.displayName + " to not " + verbPhrase + action + " " + otherString);
        });
    }
